...
set output '../../figures/payload-nested2.pdf'

#set title "Response payload using URL mapper and depth 2"
set title ""

n = 1000000
plot '../../results/nested2/payload.out' u ($2/n):($3/n):($4/n):xtic(1) ti '256x256 JPG' ls 1, \
