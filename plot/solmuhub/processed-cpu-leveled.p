...
set output '../../figures/processed-cpu-leveledCompare.pdf'

#set title "Total CPU usage for multi-hop execution"
set title ""

plot '../../results/nested2/processed-cpu.out' u 4:xtic(1) ti 'Depth 2' ls 1, \
	'../../results/nested3/processed-cpu.out' u 4:xtic(1) ti 'Depth 3' ls 2
