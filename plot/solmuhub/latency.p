...
set output '../../figures/latency-urlDataCompare.pdf'

#set title "Latency for one-hop execution"
set title ""

n = 1000
plot '../../results/urlMapped/latency.out' u ($10/n):($11/n):($12/n):xtic(1) ti 'Url mapped' ls 1, \
	'../../results/dataMapped/latency.out' u ($10/n):($11/n):($12/n):xtic(1) ti 'Data mapped' ls 2
