...
set output '../../figures/processed-cpu-urlDataCompare.pdf'

#set title "Total CPU usage for one-hop execution"
set title ""

plot '../../results/urlMapped/processed-cpu.out' u 4:xtic(1) ti 'Url mapped' ls 1, \
	'../../results/dataMapped/processed-cpu.out' u 4:xtic(1) ti 'Data mapped' ls 2
